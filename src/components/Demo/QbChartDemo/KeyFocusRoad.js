...
class KeyFocusRoad extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data1: [
        ...
        <Row>
          <Col span={12}>
            <div className={styles.tableBox}>
              <Row>
                <Col span={24}>
                  <span className={styles.chartTitle}>{this.props.chartTitle}</span>
                </Col>
                <Col span={24}>
                  <Table
                    rowKey="roadid"
          ...
          <Col span={12}>
            <div className={styles.tableBox2}>
              <Row>
                <Col span={24}>
                  <span className={styles.chartTitle}>{this.props.chartTitle2}</span>
                </Col>
                <Col span={24}>
                  <Table
                    rowKey="roadid"
